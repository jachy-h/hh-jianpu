...
```
1_ 2_ 3_ 4_   （一个一个念：哆、来、咪、发）
```

**没空格** = 用线连起来

```
1_2_3_4_      （连在一起快速念：哆来咪发）
```
...
5_6 5_4 3 1 | 5_6 5_4 3 1 | 1 5 1 - | 1 5 1 - |
```
